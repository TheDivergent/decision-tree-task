...
class Tree:
    ...
    def _get_h_score(self,node,x):#查找某一个样本的深度（即h(x)）
...
if __name__ == '__main__':
    ...
    X_train,X_test,y_train,y_test=generate_data(n_train=1000,n_test=500,contamination=0.05,behaviour="new",random_state=0)
    ...
    plt.scatter(abnormal_X[:,0],abnormal_X[:,1],s=30,edgecolors="Red",facecolor='None')
