...
class Node:
    def __init__(self,depth,idx):
        self.depth=depth
        self.idx=idx  #这个是一个N维列表

        self.left=None
        self.right=None
        self.feature=None #这个是
        self.pivot=None   #这个是分割点(特征二分点)
...
class DecisionTreeClassifier:
    """
    max_depth控制最大树深度，类功能与sklearn默认参数下的功能实现一致
    """
